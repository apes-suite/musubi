__pysys_title__   = r""" Anisotropic Gaussian passive scalar benchmark """ 
#                        ==========================
__pysys_purpose__ = r""" Testing anisotropic Gaussian passive scalar benchmark simulation in Musubi. """ 
