__pysys_title__   = r""" Semi-infinite 1D passive scalar benchmark with 2nd order source term """
#                        ==========================
__pysys_purpose__ = r""" Testing advection-diffusion-reaction of a passive scalar in a semi-infinite 1D domain with 2nd order source term in Musubi. """
