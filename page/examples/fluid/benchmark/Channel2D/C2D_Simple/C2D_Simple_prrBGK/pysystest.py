__pysys_title__   = r""" Poisueille flow through a 2D channel with the prr kernel"""
#                        ==========================
__pysys_purpose__ = r""" Testing properly working wall setups for the prr kernel"""
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    ...
    def validate(self):
        ...
        trackfile = 'channel_pressAlongLength_p00000_t2.835E+00.res'
