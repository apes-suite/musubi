__pysys_title__   = r""" Poisueille flow through a 2D channel for the rrBGK kernel""" 
#                        ==========================
__pysys_purpose__ = r""" Testing properly working wall setups with the rrBGK kernel""" 
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    ...
    def validate(self):
        ...
        trackfile = 'channel_pressAlongLength_p00000_t13.337E+00.res'
