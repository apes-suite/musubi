__pysys_title__   = r""" Poisueille flow through a 2D channel for the rBGK kernel""" 
#                        ==========================
__pysys_purpose__ = r""" Testing properly working wall setups with the rBGK kernel""" 
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    ...
    def validate(self):
        ...
        trackfile = 'channel_pressAlongLength_p00000_t12.954E+00.res'
