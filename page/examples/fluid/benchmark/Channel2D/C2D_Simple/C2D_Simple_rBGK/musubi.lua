...
boundary_condition = {
  ...
  {
    label = 'east',
    kind = 'pressure_noneq_expol', --'pressure_expol',
    pressure = press_analy,
  },
  {
    label = 'north',
...
tracking = {
  ...
  -- length. Write this output only at the end of the simulation.
  {
    ...
    shape = {
      kind = 'canoND',
      object = {
        origin = { length*0.5 + x_offset, y_offset, dx/2.0 },
        vec = { 0.0, height, 0.0},
      }
    },
    time_control = {
  ...
  -- Calculate L2-norm of press_diff variable at the end of the simulation
  {
    ...
    shape = {
      kind = 'canoND',
      object = {
        origin = { 0.0, height*0.5 + y_offset, dx/2.0 },
        vec = { length, 0.0, 0.0 },
      }
    },
    time_control = {
  ...
  -- Calculate L2-norm of vel_diff and wss_diff variable at the end of the
  -- simulation
  {
    label = 'velAndwss_l2norm',
    folder = './tracking/',
    variable = { 'vel_diff', 'wss_diff' },
    shape = {
      kind = 'canoND',
      object = {
        origin = { length*0.5 + x_offset, 0.0, dx/2.0 },
        vec = { 0.0, height, 0.0 },
      }
    },
    time_control = {
