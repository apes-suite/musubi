__pysys_title__   = r""" Poisueille flow through a 2D channel with velocity bounce back and pressure extrapolation BCs""" 
#                        ==========================
__pysys_purpose__ = r""" Testing properly boundary condition implementation velocity bounce back and pressure extrapolation""" 
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    ...
    def execute(self):
        musrun = self.apes.runMusubi(np = 11)

    def validate(self):
        self.apes.checkMusLog()
        trackfile = 'channel_DiffAlongHeight_p00000_t2.362E+00.res'
