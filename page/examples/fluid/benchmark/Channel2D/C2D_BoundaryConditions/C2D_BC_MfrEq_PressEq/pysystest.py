__pysys_title__   = r""" Poisueille flow through a 2D channel with pressure equilibrium BCs""" 
#                        ==========================
__pysys_purpose__ = r""" Testing properly boundary condition implementation pressure equilibrium""" 
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    ...
    def validate(self):
        ...
        trackfile = 'channel_DiffAlongHeight_p00000_t3.784E+00.res'
