__pysys_title__   = r""" Simple 2D channel flow using velocity equilibrium inlet boundary and pressure extrapolation outlet boundary """ 
#                        ==========================
__pysys_purpose__ = r""" Testing proper boundary condition implementation of velocity equilibrium and pressure extrapolation """ 
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    ...
    def execute(self):
        musrun = self.apes.runMusubi(np = 3)
