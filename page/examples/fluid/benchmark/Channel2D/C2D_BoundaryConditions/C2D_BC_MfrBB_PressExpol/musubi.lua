...
-- since we only compute half of the channel we need to half the mfr
mfr= rho0_phy * vel_mean_phy * height * dx * 0.5
...
--    output = { format = 'vtk' }
--  },
  -- Track difference to analytical solution along the height of the channel 
  -- near the end of the channel. Since the massinflow is not matching the 
  -- analytical solution we track near then end
  {
