__pysys_title__   = r""" Poisueille flow through a 2D channel with pressure extrapolation BCs""" 
#                        ==========================
__pysys_purpose__ = r""" Testing properly boundary condition implementation pressure extrapolation""" 
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    ...
    def validate(self):
        ...
        trackfile = 'channel_DiffAlongHeight_p00000_t5.647E+00.res'
