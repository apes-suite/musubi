...
--! [Tracking]
tracking = {
  -- Track pressure coefficient at stagnation point.
  {
    label = 'probeAt0deg',
    folder = 'tracking/',
    ...
    shape = {
      kind = 'canoND',
      object = {
        -- Adding 3/4 dx to put the point inside the cylinder and
        -- out of the fluid domain on purpose.
        origin = { -dia_cyl/2 + dx_cyl*3/4, 0, 0.0025 }
      }
    },
    time_control = {
      min = trac_start,
