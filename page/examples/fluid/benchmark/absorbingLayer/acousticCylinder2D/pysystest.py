__pysys_title__   = r""" Absorbing layer 2D cylinder """ 
#                        ==========================
__pysys_purpose__ = r""" Testing the absorbing layer for a 2D cylinder """ 
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    ...
    def validate(self):
        ...
        trackfile = 'channel_probeAt90deg_p00000.res'
