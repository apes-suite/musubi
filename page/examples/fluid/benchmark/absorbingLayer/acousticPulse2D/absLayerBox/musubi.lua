...
damp_factor = 4.0/omega-0.001 -- Maximum limit: 4.0/omega-0.001
----------------------------- Time settings ------------------------------------
tmax = 250*dt
...
-- box and radial.
source = {
  absorb_layer = 'absorblayer_box_sharp',
...
variable = {
  {
    ...
    st_fun = {
      ...
      shape = {
        ...
        kind = 'canoND',
        object = {
          origin = {-length/2.0+abs_thickness+dx, -length/2.0+abs_thickness+dx, -dx_eps},
          vec = {
            {length-2*(abs_thickness+dx), 0.0, 0.0},
            {0.0, length-2*(abs_thickness+dx), 0.0},
            {0.0, 0.0, dx + dx_eps}
          }
...
--  {
--    label = 'vtk',
--    variable = {'pressure_phy', 'absorblayer_box_sharp',
--                'absorblayer_box_round',
