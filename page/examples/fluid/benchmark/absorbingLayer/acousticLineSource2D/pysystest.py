__pysys_title__   = r""" Absorbing layer 2D line source """ 
#                        ==========================
__pysys_purpose__ = r""" Testing the absorbing layer for a 2D line source """ 
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    ...
    def validate(self):
        ...
        trackfile = 'acousticLineSrc_line_p00001_t13.988E-03.res'
