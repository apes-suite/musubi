__pysys_title__   = r""" Brinkman Channel 2D Example with TRT operator """
#                        ==========================
__pysys_purpose__ = r""" Testing Navier--Stokes--Brinkman solver in a 2D channel with TRT collision operator in Musubi. """
