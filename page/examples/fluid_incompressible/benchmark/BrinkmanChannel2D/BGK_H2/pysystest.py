__pysys_title__   = r""" Brinkman Channel 2D Example with BGK operator and H2 Brinkman force """
#                        ==========================
__pysys_purpose__ = r""" Testing Navier--Stokes--Brinkman solver in a 2D channel with BGK collision operator and H2 Brinkman force in Musubi. """
