__pysys_title__   = r""" Flow around cylinder in a channel with multiple levels """ 
#                        ==========================
__pysys_purpose__ = r""" Testing multiple levels """ 
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    ...
    def validate(self):
        ...
        trackfile = 'channel_cyl_force_p00000.res'
