__pysys_title__   = r""" Flow around cylinder in a channel, single level """ 
#                        ==========================
__pysys_purpose__ = r""" Testing incompressible flow in a channel around obstacle """ 
...
class PySysTest(ApesHelper, pysys.basetest.BaseTest):
    ...
    def validate(self):
        ...
        trackfile = 'channel_Cp_p00000_t7.500E+00.res'
