...
-- Density of the fluid [kg/m^3]
rho0_phy = 1.0
-- Factor for calculation of turbulent production
fac2 = 2.0
--------------------------------------------------------------------------------
...
--  { -- Coefficient to multiply it with production term
--    name = 'coeff_fac2',
--    ncomponents = 1,
--    vartype = 'st_fun',
--    st_fun = fac2
--  },
--  { -- Coefficient for turbVisc
--    name = 'coeff_turbVisc',
--    ncomponents = 1,
--    vartype = 'operation',
--    operation = {
--      kind = 'multiplication',
--      input_varname = { 'coeff_fac2', 'turb_viscosity_phy'}
--    }
--  },
--  { -- Production term: 2 * turb_visc * strain_rate^2
--    name = 'turbProd',
--    ncomponents = 1,
--    vartype = 'operation',
--    operation = {
--      kind = 'multiplication',
--      input_varname = {'coeff_turbVisc', 'strainSq_mag'}
--    }
--  },
}
--! [User defined variables]
